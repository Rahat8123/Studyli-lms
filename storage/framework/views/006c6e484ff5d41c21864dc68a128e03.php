    ...
    <div class="sidebar-wrapper" data-simplebar="true">
        ...
        <ul class="metismenu" id="menu">
            ...
            <li>
                ...
                <ul>
                    <li> <a href="<?php echo e(route('all.category')); ?>"><i class='bx bx-radio-circle'></i>All Category </a></li>
                    <li> <a href="<?php echo e(route('all.subcategory')); ?>"><i class='bx bx-radio-circle'></i>All SubCategory  </a>
                </ul>
            </li>
            <li>
                ...
                <ul>
                    <li> <a href="<?php echo e(route('all.instructor')); ?>"><i class='bx bx-radio-circle'></i>All Instructor</a></li>
                </ul>
            </li>
...
<?php /**PATH D:\learning management system\Studyli-lms\resources\views/admin/body/sidebar.blade.php ENDPATH**/ ?>