<header class="header-menu-area">
        ...
        <ul>
            <li>
                <div class="shop-cart-btn">
                    <div class="avatar-xs">
                        <img class="rounded-full img-fluid" src="<?php echo e((!empty($profileData->photo)) ? url('upload/user_images/'.$profileData->photo) : url('upload/no_image.jpg')); ?>" alt="Avatar image">
                    </div>
                    <span class="dot-status bg-1"></span>
                </div>
                <ul class="cart-dropdown-menu after-none p-0 notification-dropdown-menu">
    ...
    <div class="ml-2">
        <h4><a href="teacher-detail.html" class="text-black"><?php echo e($profileData->name); ?></a></h4>
        <span class="d-block fs-14 lh-20"><?php echo e($profileData->email); ?></span>
    </div>
                    </li>
...
<?php /**PATH D:\learning management system\Studyli-lms\resources\views/frontend/dashboard/body/header.blade.php ENDPATH**/ ?>