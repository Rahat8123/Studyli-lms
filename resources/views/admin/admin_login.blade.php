...
<head>
    ...
    <style>
        ...
        .login-left {
            flex: 1;
            background:
                linear-gradient(135deg, rgba(99, 102, 241, 0.95) 0%, rgba(139, 92, 246, 0.95) 50%, rgba(236, 72, 153, 0.95) 100%),
                url('https://images.unsplash.com/photo-1513475382585-d06e58bcb0e0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80') center/cover no-repeat;
            display: flex;
            align-items: center;
            justify-content: center;
            position: relative;
                    ...
                    <div style="margin-top: 1rem; font-size: 0.9rem; opacity: 0.8;">
                        <div style="display: flex; justify-content: center; gap: 2rem; margin-top: 2rem;">
                            <div style="text-align: center;">
                                ...
                                <div style="margin-top: 0.5rem; font-size: 0.8rem;">Students</div>
                            </div>
                            <div style="text-align: center;">
                                <div style="font-size: 2rem;">👩‍🏫</div>
                                <div style="margin-top: 0.5rem; font-size: 0.8rem;">Teachers</div>
                            </div>
                            <div style="text-align: center;">
                                <div style="font-size: 2rem;">📊</div>
                                <div style="margin-top: 0.5rem; font-size: 0.8rem;">Analytics</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="login-right">
                <div class="login-header">
                    <div class="logo-container">
                        <img src="{{ asset('backend/assets/images/logo-icon.png') }}" width="40" alt="Logo" style="filter: brightness(0) invert(1);">
                    </div>
                    <h1>Admin Login</h1>
